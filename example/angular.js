...
;(function(window, document, undefined) {
  ...
  let manualLowercase = function(s) {
    return isString(s)
  ...
  let manualUppercase = function(s) {
    return isString(s)
      ? s.replace(/[a-z]/g, function(ch) {
          return String.fromCharCode(ch.charCodeAt(0) & ~32)
        })
  ...
  let /** holds major version number for IE or NaN for real browsers */
  ...
  function bootstrap(element, modules) {
    let resumeBootstrapInternal = function() {
  ...
  forEach(
    {
      ...
      attr: function(element, name, value) {
        let lowercasedName = lowercase(name)
        if (BOOLEAN_ATTR[lowercasedName]) {
          ...
          let ret = element.getAttribute(name, 2)
  ...
  forEach(
    {
      ...
      triggerHandler: function(element, eventName) {
        let eventFns = (JQLiteExpandoStore(element, 'events') || {})[eventName]
  ...
  function createInjector(modulesToLoad) {
    var INSTANTIATING = {},
      ...
      providerInjector = createInternalInjector(providerCache, () => {
  ...
  function $CompileProvider($provide) {
    ...
    this.$get = [
      ...
      function(
        ...
        let Attributes = function(element, attr) {
        ...
        function applyDirectivesToNode(
          ...
          function nodeLinkFn(
            ...
            let attrs, $element, i, ii, linkFn, controller
            ...
            if (newIsolateScopeDirective) {
              ...
              let parentScope = scope.$parent || scope
        ...
        function compileTemplateUrl(
          ...
          $http
            .get(origAsyncDirective.templateUrl, { cache: $templateCache })
            .success((content) => {
        ...
        function addAttrInterpolateDirective(node, directives, value, name) {
          ...
          directives.push({
            ...
            compile: valueFn(function attrInterpolateLinkFn(
              ...
              let $$observers = attr.$$observers || (attr.$$observers = {})
  ...
  function convertToHtml5Url(url, basePath, hashPrefix) {
    ...
    // already html5 url
    if (
      decodeURIComponent(match.path) != basePath ||
      isUndefined(match.hash) ||
      ...
      return (
        composeProtocolHostPort(match.protocol, match.host, match.port) +
        pathPrefixFromBase(basePath) +
        match.hash.substr(hashPrefix.length)
      )
    }
  }
  ...
  function LocationUrl(url, pathPrefix, appBaseUrl) {
    ...
    this.$$compose = function() {
      ...
      this.$$absUrl =
        composeProtocolHostPort(this.$$protocol, this.$$host, this.$$port) +
        pathPrefix +
        this.$$url
    }
  ...
  function LocationHashbangUrl(url, hashPrefix, appBaseUrl) {
    ...
    this.$$parse = function(url) {
      ...
      if (match[1]) {
        this.$$path =
          (match[1].charAt(0) == '/' ? '' : '/') + decodeURIComponent(match[1])
      } else {
        this.$$path = ''
      }
        ...
        if (html5Mode) {
          ...
          if ($sniffer.history) {
            ...
            $location = new LocationHashbangInHtml5Url(
              ...
              hashPrefix,
              appBaseUrl,
              basePath.substr(pathPrefix.length + 1)
            )
          }
        } else {
          appBaseUrl =
      ...
      deferred = {
        ...
        promise: {
          then: function(callback, errback) {
            ...
            let wrappedCallback = function(value) {
              try {
            ...
            let wrappedErrback = function(reason) {
              try {
    ...
    this.$get = [
      ...
      function(
        ...
        function switchRouteMatcher(on, when) {
          ...
          let match = on.match(new RegExp(regex))
          if (match) {
        ...
        Scope.prototype = {
          ...
          $watch: function(watchExp, listener, objectEquality) {
            ...
            if (!isFunction(listener)) {
              let listenFn = compileToFn(listener || noop, 'listener')
      ...
      function(
        ...
        function sendReq(config, reqData, reqHeaders) {
          ...
          function removePendingReq() {
            let idx = indexOf($http.pendingRequests, config)
  ...
  function limitToFilter() {
    return function(array, limit) {
      ...
      else if (limit < -array.length) limit = -array.length
            ...
            return {
              pre: function(scope, formElement, attr, controller) {
                if (!attr.action) {
                  ...
                  let preventDefaultListener = function(event) {
                    event.preventDefault
                      ? event.preventDefault()
                      : (event.returnValue = false) // IE
                  }
  ...
  function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    let validate = function(regexp, value) {
    ...
    if (attr.ngMaxlength) {
      ...
      let maxLengthValidator = function(value) {
  ...
  function urlInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    let urlValidator = function(value) {
  ...
  var selectDirective = [
    ...
    function($compile, $parse) {
      ...
      let NG_OPTIONS_REGEXP = /^\s*(.*?)(?:\s+as\s+(.*?))?(?:\s+group\s+by\s+(.*))?\s+for\s+(?:([\$\w][\$\w\d]*)|(?:\(\s*([\$\w][\$\w\d]*)\s*,\s*([\$\w][\$\w\d]*)\s*\)))\s+in\s+(.*)$/,
      ...
      return {
        ...
        link: function(scope, element, attr, ctrls) {
          ...
          if (multiple && (attr.required || attr.ngRequired)) {
            let requiredValidator = function(value) {
          ...
          function Single(scope, selectElement, ngModelCtrl, selectCtrl) {
            ngModelCtrl.$render = function() {
              let viewValue = ngModelCtrl.$viewValue
          ...
          function Multiple(scope, selectElement, ctrl) {
            let lastView
            ctrl.$render = function() {
              let items = new HashMap(ctrl.$viewValue)
          ...
          function Options(scope, selectElement, ctrl) {
            ...
            function render() {
              let optionGroups = { '': [] }, // Temporary location for the option groups before we render them
                optionGroupNames = [''],
                optionGroupName,
                optionGroup,
                option,
              ...
              for (index = 0; (length = keys.length), index < length; index++) {
                ...
                if (multiple) {
                  selected =
                    selectedSet.remove(valueFn(scope, locals)) != undefined
                } else {
